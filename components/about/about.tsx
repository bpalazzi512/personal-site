    ...
    return (
        <div id="about" className="min-h-screen w-full flex flex-col items-center max-w-3xl scroll-mt-15">
            ...
            <div className="flex flex-row mt-6">
                <a href="https://www.linkedin.com/in/bobby-palazzi/">
                    <LinkedinIcon color='#0a66c2' size="40px"/>
                </a>

                <a href="https://www.github.com/bpalazz512">
                    <Github color='#2b3137' size="40px" />
                </a>
                
                
            </div>
            <a href="" className="bg-slate-100 px-3 py-1 rounded-md h-12 flex items-center justify-center mt-4">
